...
> "Can evolutionary search over latent knowledge representation spaces discover novel military tactics beyond those historically employed?"
...
- Evolutionary planning in latent space knowledge representation: [https://arxiv.org/pdf/2011.11293](https://arxiv.org/pdf/2011.11293)
- Discovering representations with black box optimization: [https://dl.acm.org/doi/abs/10.1145/3377930.3390221](https://dl.acm.org/doi/abs/10.1145/3377930.3390221)
- Strategy representation in multi-agent games without information leakage: [https://arxiv.org/abs/2409.19363](https://arxiv.org/abs/2409.19363)
- NEAT paper: [https://nn.cs.utexas.edu/downloads/papers/stanley.cec02.pd](https://nn.cs.utexas.edu/downloads/papers/stanley.cec02.pd)
- battle of trafalgar order of battle: [https://en.wikipedia.org/wiki/Battle_of_Trafalgar_order_of_battle](https://en.wikipedia.org/wiki/Battle_of_Trafalgar_order_of_battle) 
- battle timeline: [https://www.rmg.co.uk/stories/maritime-history/battle-trafalgar-timeline](https://www.rmg.co.uk/stories/maritime-history/battle-trafalgar-timeline)
